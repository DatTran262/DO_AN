...
#             # print('union.')
#             self.moveJoint(id = jointAct.jointID, targetValue = jointAct.targetValue, speed = jointAct.speed) 
#         elif (jointAct.lockType == 'lockpart'):
#             self.lock_part('lefthand', jointAct.jointID)    
#             self.moveJoint(id = jointAct.jointID, targetValue = jointAct.targetValue, speed = jointAct.speed)
#             self.lock_part('lefthand', jointAct.jointID)  
#         else:
...
# class Zip:
#     def __init__(self, name, lockPart):
#         self.name = name
...
class TimeTable:
    ...
    def addLock(self, lockAct):
        if lockAct.name == 'Follow joint':
            self.lock_follow_joint(lockAct.id)
            return
    ...
    def lock_follow_joint(self, id):
        max_rowLen = self.max_len_follow_joint(id)
