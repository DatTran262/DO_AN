...
class Ui(QtWidgets.QMainWindow):
    ...
    def save_button_clicked(self):
        if self.tempPopup.tabWidgetAction.tabText(self.tempPopup.tabWidgetAction.currentIndex()) == 'Joint Action':
            ...
            if self.tempPopup.checkBoxF_0.isChecked(): temp_part.append('0')
            if self.tempPopup.checkBoxF_1.isChecked(): temp_part.append('1')
            if self.tempPopup.checkBoxF_2.isChecked(): temp_part.append('2')
            if self.tempPopup.checkBoxF_3.isChecked(): temp_part.append('3')
            if self.tempPopup.checkBoxF_4.isChecked(): temp_part.append('4')
